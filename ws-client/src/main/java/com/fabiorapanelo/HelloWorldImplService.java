 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://fabiorapanelo.com/", wsdlLocation = "http://localhost:8080/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://fabiorapanelo.com/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://fabiorapanelo.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://fabiorapanelo.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
